...
class LoymaxWebApp_configs
{
    ...
    public function __construct() {
        ...
        $this->loymax_config_data_defaults = array(
            ...
            'apiVersion' => array(
                'name' => 'Publicapi version (version "22.1" by default)',
                'value' => '22.1',
                'type' => 'text',
                'isOption' => true,
            ),
            ...
            'turnOnOfferModal' => array(
                'name' => 'Popup modal with email confirmation',
                'value' => 'true',
                'type' => 'bool',
                'isOption' => true,
            ),
            'echequeLogicalName' => array(
                'name' => 'Logical name of the question for agreeing to receive e-cheques',
                'value' => '',
                'type' => 'text',
                'isOption' => true,
            ),
            'modalShowTimeout' => array(
                'name' => 'Time (in seconds) after which modal popup after authorization',
                'value' => 2,
                'type' => 'number',
                'isOption' => true,
            ),
            'modalShowInterval' => array(
                'name' => 'Time interval (in hours) after which the modal window will appear again after it is closed',
                'value' => 1,
                'type' => 'number',
                'isOption' => true,
            ),
            'maxPopupNumber' => array(
                'name' => 'Maximum number of popup',
                'value' => 5,
                'type' => 'number',
                'isOption' => true,
            ),
            'popupText' => array(
                'name' => 'Text in modal to bind email',
                'value' => 'Подпишись на нашу рассылку и получи <b>200</b> бонусных рублей',
                'type' => 'text',
                'isOption' => true,
            ),
            ...
            'balanceChangeHistory' => array(
                'name' => 'Отображать в истории операций историю изменения баланса',
                'value' => 'false',
                'type' => 'bool',
                'isOption' => true,
                'component' => 'history',
            ),
            'isBalanceChangeHistoryForCurrentUser' => array(
                'name' => 'Запрашивать изменение баланса только для текущего Участника',
                'value' => 'false',
                'type' => 'bool',
                'isOption' => true,
                'component' => 'history',
            ),
            'userBalanceHistoryAttributeName' => array(
                'name' => 'Логическое имя атрибута для истории изменения баланса',
                'value' => '',
                'type' => 'text',
                'isOption' => true,
                'component' => 'history',
            ...
            'resendTimer' => array(
                'name' => 'Time in seconds between resending the confirmation code',
                'value' => 0,
                'type' => 'number',
                'isOption' => true,
            ),
        ...
        $this->loymax_new_in_version = array(
            ...
            '3.1' => array(
                ...
                'isBalanceChangeHistoryForCurrentUser',
