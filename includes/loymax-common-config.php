...
/**
 * Класс для оображения общих опций (опций, не относящихся к какому-либо компоненту)
 */
class LoymaxWebApp_common_config {
    ...
    /**
     * Получает из БД все общие опции
    ...
    /**
     * Генерирует html таблицу опций
     * Используется для общих настроек и настроек компонентов
     * @param {array} $configs массив опций
     */
    ...
    /**
     * Отображает форму общих настроек
