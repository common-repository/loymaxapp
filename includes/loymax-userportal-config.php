<?php
/**
 * Класс для оображения опций компонентов
 */
class LoymaxWebApp_userportal_config {
    ...
    /**
     * Получает из БД опции для заданного компонента
    ...
    /**
     * Получает из БД таблицу компонентов
    ...
    /**
     * Добавляет к каждому компоненту его порядок отображения
     * @param array $components компоненты
     */
    ...
    /**
     * Отображает форму настроек модулей
     * @param bool $is_installation признак того, что это шаг мастера установки
     */
    public function show($is_installation = false) {
        if ( !$is_installation ) {
            ?>
            <script type="text/javascript">
                // На странице настроек плагина при изменении выбора компонента отправляем запрос
                jQuery(function($){
        ...
        <script type="text/javascript">
            ...
            /**
             * Изменяет видимость формы с настройками компонента
             * @param element форма
             */
            ...
            /**
             * В помощнике установки задает значение выбран компонент или нет
             * @param element html элемент выбора компонента
             */
    ...
    /**
     * Устанавливает в БД выбран компонент или нет
     */
    ...
    /**
     * Обновляет в БД данные из формы настроек компонентов
     */
    ...
    /**
     * Обновляет порядок отображения элементов меню в соответствии с порядком отображения компонентов
     * @param $orders
     */
