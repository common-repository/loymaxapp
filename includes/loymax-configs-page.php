...
/**
 * Класс страницы настроек плагина
 */
class LoymaxWebApp_settings_page {
    public function __construct() {}

    /**
     * Создает заголовок страницы настроек плагина (логотип и табы для переключения вкладок)
     */
    ...
    /**
     * Создает вкладки страницы настроек плагина (логотип и табы для переключения вкладок)
     */
    ...
    /**
     * Создаёт страницу настроек плагина
     */
