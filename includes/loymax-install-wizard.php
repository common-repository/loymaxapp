<?php
/**
 * Класс помощника устаноки (настройки) плагина
 */
class LoymaxWebApp_install_wizard {
    ...
    /**
     * Подключает необходимые стили и скрипты
     */
    ...
    /**
     * Создает отображение первого шага установки
     */
    ...
    /**
     * Создает отображение последнего шага установки
     */
    ...
    /**
     * Получает ссылку на следующий шаг
    ...
    static function get_next_step_link( $step = '' ) {
        ...
        // Если текущий шаг является последним, возвращаем ссылку на страницу админки
        if ( end( $keys ) === $step ) {
            return admin_url();
        }
        ...
        // Устанавливаем в url нужный шаг и возвращаем получившийся url
        return add_query_arg( 'step', $keys[ $step_index + 1 ] );
    }

    /**
     * Отображает страницу помощника установки
     */
    public function show() {
        // Если текущий шаг 'exit' - выходим из установщика
    ...
    /**
     * Создает заголовок страницы помощника установки
     */
    ...
    /**
     * Создает футер страницы помощника установки
     */
    ...
    /**
     * Создает точки отображения шагов помощника установки
     */
