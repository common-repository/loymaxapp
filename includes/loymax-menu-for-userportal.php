<?php
/**
 * Класс для работы с меню для ЛК
 */
class LoymaxWebApp_menu_for_userportal {
    ...
    public function create_menu_for_page( ) {
        ...
        // Если меню уже было создано - удаляем его
    ...
    /**
     * Обновляет ссылки у элементов меню
     */
    ...
    /**
     * Обновляет видимость элементов меню
     */
    ...
    /**
     * Изменяет порядок отображения элементов меню
     * @param array $updated_order содержит названия компонентов и их порядок отображения
     */
    ...
    /**
     * Определяет список классов стилей для элемента меню
     * @param object $item элемент меню
     * @return string классы стилей, разделенные пробелом
     */
    ...
    /**
     * Добавляет необходимые для дальнейшей работы поля к конпонентам
     * @param $components
     * @return array
     */
