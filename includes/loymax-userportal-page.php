...
/**
 * Класс для работы со страницей ЛК
 */
class LoymaxWebApp_userportal_page {
    ...
    /**
     * Создает модальное окно восстановления страницы ЛК из корзины
     */
    ...
    /**
     * Отображает форму настройки страницы ЛК
     */
    ...
    /**
     * Создает страницу ЛК
     * @param LoymaxWebApp_Plugin $plugin
     */
    ...
    /**
     * Возвращает на публикацию страницу ЛК
     * @param int $loymax_page_ID идентификатор страницы ЛК
     */
    ...
    /**
     * Отображает страницу настроек страницы ЛК
     */
